<div class="row mb-4">
    <div class="col-md-12">
        <div class="card" style="background-image: url('{{ '/images/jumbotron.png' }}')">
            <div class="text-white text-center d-flex align-items-center py-5 px-4 my-5">
                ...
                <div class="col-5 text-left">
                    ...
                    <h5>{{ __("Categoría") }}: {{ $course->category->name }}</h4>
                    <h5>{{ __("Fecha de publicación") }}: {{ $course->created_at->format('d/m/Y') }}</h5>
                    <h5>{{ __("Fecha de actuaización") }}: {{ $course->updated_at->format('d/m/Y') }}</h5>
